      ...
      <div class="card-body">
        <ul class="list-unstyled mb-0 vstack gap-3">
          <li>
            <div class="d-flex align-items-center">
              <div class="flex-grow-1 ms-3">
                <h6 class="fs-14 mb-1">Avrielle Haven Fernandez Juarez</h6>
                <p class="text-muted mb-0">Customer</p>
              </div>
            </div>
          </li>
          <li><i class="ri-mail-line me-2 align-middle text-muted fs-16"></i>avijuarez@gmail.com</li>
          <li><i class="ri-phone-line me-2 align-middle text-muted fs-16"></i>09872537193</li>
        </ul>
      </div>
    </div>
    <!--end card-->
