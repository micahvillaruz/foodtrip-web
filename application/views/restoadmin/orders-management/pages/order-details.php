    ...
    <div class="card">
      <div class="card-header">
        <div class="d-flex align-items-center">
          <h5 class="card-title flex-grow-1 mb-0">Order #1400090321</h5>
          ...
          <div class="accordion accordion-flush" id="accordionFlushExample">
            <div class="accordion-item border-0">
              ...
              <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div class="accordion-body ms-2 ps-5 pt-0">
                  ...
                  <p class="text-muted">Wed, 15 Dec 2021 - 02:05PM</p>
            ...
            <div class="accordion-item border-0">
              ...
              <div id="collapseThree" class="accordion-collapse collapse show" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                <div class="accordion-body ms-2 ps-5 pt-0">
                  <h6 class="fs-14">Grab Express- MFDS1400457854</h6>
                  <h6 class="mb-1">Your item has been picked up by the courier partner.</h6>
                  <p class="text-muted mb-0">Sat, 09 Jul 2022 - 02:48 PM</p>
                </div>
              </div>
            </div>
                ...
                <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapseFile" aria-expanded="false">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                      ...
                      <p class="text-muted mb-0">Sat, 09 Jul 2022 - 03:29 PM</p>
                    </div>
                  </div>
                </a>
              </div>
    ...
    <div class="card">
      ...
      <div class="card-body">
        <ul class="list-unstyled mb-0 vstack gap-3">
          ...
          <li><i class="ri-phone-line me-2 align-middle text-muted fs-16"></i>09264771621</li>
        </ul>
      </div>
    </div>
