    ...
    <div class="container-fluid">
      <div class="profile-foreground position-relative mx-n4 mt-n4">
        <div class="profile-wid-bg">
          <img src="<?php echo base_url('public/assets') ?>/images/profile-bg.jpg" alt="" class="profile-wid-img" />
        </div>
      </div>
      <div class="pt-4 mb-4 mb-lg-3 pb-lg-4">
        <div class="row g-4">
          <div class="col-auto">
            <div class="avatar-lg">
              <img src="<?php echo base_url('public/assets') ?>/images/users/avatar-1.jpg" alt="user-img" class="img-thumbnail rounded-circle" />
            </div>
          </div>
          <!--end col-->
          <div class="col">
                        ...
                        <div>
                          <div class="d-flex align-items-center py-3">
                            <div class="avatar-xs flex-shrink-0 me-3">
                              <img src="<?php echo base_url('public/assets') ?>/images/users/avatar-3.jpg" alt="" class="img-fluid rounded-circle shadow" />
                            </div>
                            <div class="flex-grow-1">
                              <div>
                          ...
                          <div class="d-flex align-items-center py-3">
                            <div class="avatar-xs flex-shrink-0 me-3">
                              <img src="<?php echo base_url('public/assets') ?>/images/users/avatar-4.jpg" alt="" class="img-fluid rounded-circle shadow" />
                            </div>
                            <div class="flex-grow-1">
                              <div>
                          ...
                          <div class="d-flex align-items-center py-3">
                            <div class="avatar-xs flex-shrink-0 me-3">
                              <img src="<?php echo base_url('public/assets') ?>/images/users/avatar-5.jpg" alt="" class="img-fluid rounded-circle shadow" />
                            </div>
                            <div class="flex-grow-1">
                              <div>
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="d-flex mb-4">
                          <div class="flex-shrink-0">
                            <img src="<?php echo base_url('public/assets') ?>/images/small/img-4.jpg" alt="" height="50" class="rounded shadow" />
                          </div>
                        ...
                        <div class="d-flex mb-4">
                          <div class="flex-shrink-0">
                            <img src="<?php echo base_url('public/assets') ?>/images/small/img-5.jpg" alt="" height="50" class="rounded shadow" />
                          </div>
                          <div class="flex-grow-1 ms-3 overflow-hidden">
                            <a href="javascript:void(0);">
                        ...
                        <div class="d-flex">
                          <div class="flex-shrink-0">
                            <img src="<?php echo base_url('public/assets') ?>/images/small/img-6.jpg" alt="" height="50" class="rounded shadow" />
                          </div>
                          <div class="flex-grow-1 ms-3 overflow-hidden">
                            <a href="javascript:void(0);">
                                    ...
                                    <div class="accordion-item border-0">
                                      <div class="accordion-header" id="headingOne">
                                        <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapseOne" aria-expanded="true">
                                          <div class="d-flex">
                                            <div class="flex-shrink-0">
                                              <img src="<?php echo base_url('public/assets') ?>/images/users/avatar-2.jpg" alt="" class="avatar-xs rounded-circle shadow" />
                                            </div>
                                    ...
                                    <div class="accordion-item border-0">
                                      <div class="accordion-header" id="headingThree">
                                        <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapsethree" aria-expanded="false">
                                          <div class="d-flex">
                                            <div class="flex-shrink-0">
                                              <img src="<?php echo base_url('public/assets') ?>/images/users/avatar-5.jpg" alt="" class="avatar-xs rounded-circle shadow" />
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="accordion-item border-0">
                                      <div class="accordion-header" id="headingFive">
                                        <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapseFive" aria-expanded="true">
                                          <div class="d-flex">
                                            <div class="flex-shrink-0">
                                              <img src="<?php echo base_url('public/assets') ?>/images/users/avatar-7.jpg" alt="" class="avatar-xs rounded-circle shadow" />
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                              <h6 class="fs-14 mb-1">
                                                Lewis Arnold
                                        ...
                                        <div class="accordion-body ms-2 ps-5">
                                          ...
                                          <div class="avatar-group">
                                            <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="Christi">
                                              <img src="<?php echo base_url('public/assets') ?>/images/users/avatar-4.jpg" alt="" class="rounded-circle avatar-xs">
                                            </a>
                                            <a href="javascript: void(0);" class="avatar-group-item shadow" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="" data-bs-original-title="Frank Hook">
                                              <img src="<?php echo base_url('public/assets') ?>/images/users/avatar-3.jpg" alt="" class="rounded-circle avatar-xs">
                                            </a>
                                    ...
                                    <div class="accordion-item border-0">
                                      <div class="accordion-header" id="heading6">
                                        <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapse6" aria-expanded="true">
                                          <div class="d-flex">
                                            <div class="flex-shrink-0">
                                              <img src="<?php echo base_url('public/assets') ?>/images/users/avatar-3.jpg" alt="" class="avatar-xs rounded-circle shadow" />
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                              <h6 class="fs-14 mb-1">
                                                Joseph Parker
                                          ...
                                          <div class="row mt-2">
                                            <div class="col-xxl-6">
                                              <div class="row border border-dashed gx-2 p-2 shadow">
                                                <div class="col-3">
                                                  <img src="<?php echo base_url('public/assets') ?>/images/small/img-3.jpg" alt="" class="img-fluid rounded shadow" />
                                                </div>
                                                <!--end col-->
                                                <div class="col-3">
                                                  <img src="<?php echo base_url('public/assets') ?>/images/small/img-5.jpg" alt="" class="img-fluid rounded shadow" />
                                                </div>
                                                <!--end col-->
                                                <div class="col-3">
                                                  <img src="<?php echo base_url('public/assets') ?>/images/small/img-7.jpg" alt="" class="img-fluid rounded shadow" />
                                                </div>
                                                <!--end col-->
                                                <div class="col-3">
                                                  <img src="<?php echo base_url('public/assets') ?>/images/small/img-9.jpg" alt="" class="img-fluid rounded shadow" />
                                                </div>
                                                <!--end col-->
                                              </div>
                                              <!--end row-->
                                    ...
                                    <div class="accordion-item border-0">
                                      <div class="accordion-header" id="heading9">
                                        <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse" href="#collapse9" aria-expanded="false">
                                          <div class="d-flex">
                                            <div class="flex-shrink-0">
                                              <img src="<?php echo base_url('public/assets') ?>/images/users/avatar-6.jpg" alt="" class="avatar-xs rounded-circle shadow" />
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                              <h6 class="fs-14 mb-1">
                                      ...
                                      <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div class="avatar-group">
                                          <div class="avatar-group-item shadow">
                                            <div class="avatar-xs">
                                              <img src="<?php echo base_url('public/assets') ?>/images/users/avatar-4.jpg" alt="" class="rounded-circle img-fluid" />
                                            </div>
                                          </div>
                                          <div class="avatar-group-item shadow">
                                            <div class="avatar-xs">
                                              <img src="<?php echo base_url('public/assets') ?>/images/users/avatar-5.jpg" alt="" class="rounded-circle img-fluid" />
                                            </div>
                                          </div>
                                          <div class="avatar-group-item shadow">
                                            <div class="avatar-xs">
                                          ...
                                          <div class="avatar-group-item shadow">
                                            <div class="avatar-xs">
                                              <img src="<?php echo base_url('public/assets') ?>/images/users/avatar-2.jpg" alt="" class="rounded-circle img-fluid" />
                                            </div>
                                          </div>
                                        </div>
                                      </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="acitivity-timeline">
                      <div class="acitivity-item d-flex">
                        <div class="flex-shrink-0">
                          <img src="<?php echo base_url('public/assets') ?>/images/users/avatar-1.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar shadow" />
                        </div>
                        <div class="flex-grow-1 ms-3">
                      ...
                      <div class="acitivity-item py-3 d-flex">
                        <div class="flex-shrink-0">
                          <img src="<?php echo base_url('public/assets') ?>/images/users/avatar-2.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar shadow" />
                        </div>
                        <div class="flex-grow-1 ms-3">
                          ...
                          <div class="row">
                            <div class="col-xxl-4">
                              <div class="row border border-dashed gx-2 p-2 mb-2">
                                <div class="col-4">
                                  <img src="<?php echo base_url('public/assets') ?>/images/small/img-2.jpg" alt="" class="img-fluid rounded shadow" />
                                </div>
                                <!--end col-->
                                <div class="col-4">
                                  <img src="<?php echo base_url('public/assets') ?>/images/small/img-3.jpg" alt="" class="img-fluid rounded shadow" />
                                ...
                                <!--end col-->
                                <div class="col-4">
                                  <img src="<?php echo base_url('public/assets') ?>/images/small/img-4.jpg" alt="" class="img-fluid rounded shadow" />
                                </div>
                                <!--end col-->
                              </div>
                              <!--end row-->
                      ...
                      <div class="acitivity-item py-3 d-flex">
                        <div class="flex-shrink-0">
                          <img src="<?php echo base_url('public/assets') ?>/images/users/avatar-6.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar shadow" />
                        </div>
                        <div class="flex-grow-1 ms-3">
                      ...
                      <div class="acitivity-item py-3 d-flex">
                        <div class="flex-shrink-0">
                          <img src="<?php echo base_url('public/assets') ?>/images/users/avatar-7.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar shadow" />
                        </div>
                        <div class="flex-grow-1 ms-3">
                      ...
                      <div class="acitivity-item d-flex">
                        <div class="flex-shrink-0">
                          <img src="<?php echo base_url('public/assets') ?>/images/users/avatar-8.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar shadow" />
                        </div>
                        <div class="flex-grow-1 ms-3">
                              ...
                              <div class="flex-grow-1">
                                <div class="d-flex align-items-center gap-2">
                                  ...
                                  <div class="avatar-group">
                                    <div class="avatar-group-item shadow">
                                      <div class="avatar-xs">
                                        <img src="<?php echo base_url('public/assets') ?>/images/users/avatar-1.jpg" alt="" class="rounded-circle img-fluid" />
                                      </div>
                                    </div>
                                    <div class="avatar-group-item shadow">
                                      <div class="avatar-xs">
                                        <img src="<?php echo base_url('public/assets') ?>/images/users/avatar-3.jpg" alt="" class="rounded-circle img-fluid" />
                                      </div>
                                    </div>
                                    <div class="avatar-group-item shadow">
                                      <div class="avatar-xs">
                              ...
                              <div class="flex-grow-1">
                                <div class="d-flex align-items-center gap-2">
                                  ...
                                  <div class="avatar-group">
                                    <div class="avatar-group-item shadow">
                                      <div class="avatar-xs">
                                        <img src="<?php echo base_url('public/assets') ?>/images/users/avatar-8.jpg" alt="" class="rounded-circle img-fluid" />
                                      </div>
                                    </div>
                                    <div class="avatar-group-item shadow">
                                      <div class="avatar-xs">
                                        <img src="<?php echo base_url('public/assets') ?>/images/users/avatar-7.jpg" alt="" class="rounded-circle img-fluid" />
                                      </div>
                                    </div>
                                    <div class="avatar-group-item shadow">
                                      <div class="avatar-xs">
                                        <img src="<?php echo base_url('public/assets') ?>/images/users/avatar-6.jpg" alt="" class="rounded-circle img-fluid" />
                                      </div>
                                    </div>
                                    <div class="avatar-group-item shadow">
                                      <div class="avatar-xs">
