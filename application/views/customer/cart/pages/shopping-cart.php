                ...
                <div class="row gy-3">
                    ...
                    <div class="col-sm-auto">
                        <div class="text-lg-end">
                            ...
                            <h5 class="fs-14">₱<span id="ticket_price" class="product-price">776.00</span></h5>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center gy-3">
                    ...
                    <div class="col-sm-auto">
                        <div class="d-flex align-items-center gap-2 text-muted">
                            <div>Total :</div>
                            <h5 class="fs-14 mb-0">₱<span class="product-line-price">776.00</span></h5>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card product">
            <div class="card-body">
                <div class="row gy-3">
                    ...
                    <div class="col-sm">
                        <h5 class="fs-14 text-truncate"><a href="#!" class="text-dark">Amazing Aloha Champ Jr.</a></h5>
                        <ul class="list-inline text-muted">
                            <li class="list-inline-item">Category : <span class="fw-medium">Burgers</span></li>
                        </ul>
                    ...
                    <div class="col-sm-auto">
                        <div class="text-lg-end">
                            <p class="text-muted mb-1">Item Price:</p>
                            <h5 class="fs-14">₱<span id="ticket_price" class="product-price">109.00</span></h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-footer">
                <div class="row align-items-center gy-3">
                    ...
                    <div class="col-sm-auto">
                        <div class="d-flex align-items-center gap-2 text-muted">
                            <div>Total :</div>
                            <h5 class="fs-14 mb-0">₱<span class="product-line-price">545.00</span></h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row gy-3">
                    ...
                    <div class="col-sm-auto">
                        <div class="text-lg-end">
                            <p class="text-muted mb-1">Item Price:</p>
                            <h5 class="fs-14">₱<span id="ticket_price" class="product-price">143.00</span></h5>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-footer">
                <div class="row align-items-center gy-3">
                    ...
                    <div class="col-sm-auto">
                        <div class="d-flex align-items-center gap-2 text-muted">
                            <div>Total :</div>
                            <h5 class="fs-14 mb-0">₱<span class="product-line-price">429.00</span></h5>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="table-responsive pt-2">
                            <table class="table table-borderless mb-0">
                                <tbody>
                                    <tr>
                                        <td>Sub Total :</td>
                                        <td class="text-end" id="cart-subtotal">₱1,750.00</td>
                                    </tr>
