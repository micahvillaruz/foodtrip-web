                    ...
                    <div class="card-header border-bottom-dashed p-4">
                        <div class="d-flex">
                            ...
                            <div class="flex-shrink-0 mt-sm-0 mt-3">
                                <h6><span class="text-muted fw-normal">Restaurant Name: </span><span>Jollibee</span></h6>
                                <h6><span class="text-muted fw-normal">Category: </span><span>Fast Food</span></h6>
                                <h6><span class="text-muted fw-normal">Email: </span><span>feedback@jollibee.com.ph</span></h6>
                                <h6><span class="text-muted fw-normal">Website: </span><a href="https://www.jollibee.com.ph/" class="link-primary" target="_blank">www.jollibee.com.ph</a></h6>
                                <h6 class="mb-0"><span class="text-muted fw-normal">Landline No: </span><span id="contact-no">(02) 8-7000</span></h6>
                            </div>
                        </div>
                    </div>
                    <!--end card-header-->
                    ...
                    <div class="card-body p-4">
                        <div class="row g-3">
                            <div class="col-lg-3 col-6">
                                ...
                                <h5 class="fs-14 mb-0">#<span id="payment-no">60524012573</span></h5>
                            </div>
                            <!--end col-->
                            <div class="col-lg-3 col-6">
                                <p class="text-muted mb-2 text-uppercase fw-semibold">Date</p>
                                <h5 class="fs-14 mb-0"><span id="invoice-date">18 Jul, 2022</span> <small class="text-muted" id="invoice-time">11:30AM</small></h5>
                            </div>
                            <!--end col-->
                            <div class="col-lg-3 col-6">
                            ...
                            <div class="col-lg-3 col-6">
                                ...
                                <h5 class="fs-14 mb-0">₱<span id="total-amount">1,750.00</span></h5>
                            </div>
                            <!--end col-->
                        </div>
                        <!--end row-->
                    ...
                    <div class="card-body p-4 border-top border-top-dashed">
                        <div class="row g-3">
                            <div class="col-6">
                                ...
                                <p class="fw-medium mb-2">Avrielle Haven Fernandez Juarez</p>
                                ...
                                <p class="text-muted mb-1"><span>Phone: </span><span>09872537193</span></p>
                                <p class="text-muted mb-0"><span>Email: </span><span id="email">avijuarez@gmail.com</span></p>
                            </div>
                            <!--end col-->
                            <div class="col-6">
                ...
                <div class="col-lg-12">
                    <div class="card-body p-4">
                        ...
                        <div class="mt-3">
                            ...
                            <p class="text-muted mb-1">Payment Number: <span class="fw-medium">60524012573</span></p>
                            <p class="text-muted mb-1">Payment Status: <span class="fw-medium">Paid</span></p>
                            <p class="text-muted mb-1">Date Paid: <span class="fw-medium">18 Jul,2022 11:30 AM</span></p>
                            <p class="text-muted">Total Amount: <span class="fw-medium">₱</span><span id="card-total-amount">1,750.00</span></p>
                        </div>
