                  ...
                  <div class="swiper effect-fade-swiper rounded h-100">
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <img src="<?php echo base_url('public/assets') ?>/images/small/admin-1.jpg" alt="" class="foodtrip-bg" />
                      </div>
                      <div class="swiper-slide">
                        <img src="<?php echo base_url('public/assets') ?>/images/small/admin-2.jpg" alt="" class="foodtrip-bg" />
                      </div>
                      <div class="swiper-slide">
                        <img src="<?php echo base_url('public/assets') ?>/images/small/admin-3.jpg" alt="" class="foodtrip-bg" />
                      </div>
                    </div>
                ...
                <div class="col-lg-6">
                  <div class="p-lg-5 p-4">
                    <div>
                      ...
                      <h5 class="text-primary">Register a Restaurant Admin</h5>
