                    ...
                    <div class="col-xl-8">
                        <div class="mt-xl-0 mt-5">
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    ...
                                    <div class="hstack gap-3 flex-wrap">
                                        <div><a href="#" class="text-primary d-block">Super Meals</a></div>
                                        <div class="vr"></div>
                                        <div class="text-muted">Restaurant : <span class="text-body fw-medium">Jollibee</span></div>
                                        <div class="vr"></div>
                            ...
                            <div class="product-content mt-5">
                                <h5 class="fs-14 mb-3">Dish Description :</h5>
                                <nav>
                                ...
                                <div class="tab-content border border-top-0 p-4" id="nav-tabContent">
                                    ...
                                    <div class="tab-pane fade" id="nav-detail" role="tabpanel" aria-labelledby="nav-detail-tab">
                                        <div>
                                            <h5 class="font-size-16 mb-3">1 - pc. Chickenjoy w/ Half Jolly Spaghetti & Shanghai Super Meal</h5>
                                            <p>Your Jollibee favorites in one Supermeal: 1pc. Chickenjoy with 3pcs. Shanghai and Half Jolly Spaghetti, with Rice and Drink.</p>
                                        </div>
                                    </div>
                                </div>
