                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="mb-3">
                          ...
                          <div class="form-icon">
                            <input type="text" class="form-control form-control-icon" id="first_name" placeholder="Enter your First Name" value="Paul">
                      ...
                      <div class="col-lg-12">
                        <div class="mb-3">
                          ...
                          <div class="form-icon">
                            <input type="text" class="form-control form-control-icon" id="last_name" placeholder="Enter your Last Name" value="Tulod">
                      ...
                      <div class="col-lg-12">
                        <div class="mb-3">
                          ...
                          <div class="form-icon">
                            <input type="email" class="form-control form-control-icon" id="email_address" placeholder="Enter your Email Address" value="paultulod@pm.me">
