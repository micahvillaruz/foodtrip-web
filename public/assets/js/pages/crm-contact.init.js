...
(xhttp.onload = function () {
	JSON.parse(this.responseText).forEach(function (e) {
		...
		t.forEach((e, t) => {
			...
			contactList.add({
				...
				name:
					`<div class="d-flex align-items-center">            <div class="flex-shrink-0"><img src="${baseURL}public/` +
					e.name[0] +
	...
	xhttp.open("GET", `${baseURL}public/assets/json/contact-list.json`),
	xhttp.send(),
...
function clearFields() {
	(customerImg.src = `${baseURL}public/assets/images/users/user-dummy-img.jpg`),
...
tagInputFieldValue.forEach((e, t) => {
	tagHtmlValue +=
