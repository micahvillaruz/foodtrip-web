var url = window.location.origin + `${baseURL}public/assets/json/`,
	allmaillist = "";
...
getJSON("mail-list.init.json", function (e, t) {
	...
	document.querySelectorAll(".mail-list a").forEach(function (l) {
...
var dummyUserImage = `${baseURL}public/assets/images/users/user-dummy-img.jpg`,
	mailChatDetailElm = !1;
function emailDetailChange() {
	document.querySelectorAll(".message-list li").forEach(function (c) {
